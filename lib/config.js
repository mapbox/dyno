...
module.exports = function(c){
    ...
    if(c.kinesisEndpoint && c.kinesisStream && c.kinesisPartitionAttribute) {
        config.kinesis = new AWS.Kinesis({ endpoint: config.kinesisEndpoint });
        // TODO make sure SSL is enabled or make configurable
    }
