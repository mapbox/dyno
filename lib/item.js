...
items.putItem = function(doc, opts, cb) {
    ...
    if(opts.operator) params.ConditionalOperator = opts.operator;
    if(opts.capacity) params.ReturnConsumedCapacity = opts.capacity;
    if(opts.metrics) params.ReturnItemCollectionMetrics = opts.metrics;
    if(opts.values) params.ReturnValues = opts.values;
